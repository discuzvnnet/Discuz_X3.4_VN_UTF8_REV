...
(
	...
	'feed_album_body' => '<b>{album}</b><br /> Tất cả có {picnum} hình ảnh',
	...
	'feed_reply_title' =>			'{actor} trả lời {author} trong chủ đề {subject}',
	'feed_reply_title_anonymous' =>		'{actor} Trả lời chủ đề {subject}',
	'feed_reply_message' =>			'',
